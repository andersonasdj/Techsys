		...
		<form action="salvarSuporte" method="post"
			...
			<div class="text-left fonte-letras">
				...
				<div class="control-group">
					<label class="control-label"><b>Upgrade - Cotação SSD</b></label>
					<div class="controls">
						<input name="classproblema" type="radio" value="Upgrade - Cotação SSD"
							class="form-check-input" class="input-xlarge">
					</div>
				</div>

				<div class="control-group">
					<label class="control-label"><b>Upgrade - Cotação memória</b></label>
					<div class="controls">
						<input name="classproblema" type="radio" value="Upgrade - Cotação memória"
							class="form-check-input" class="input-xlarge">
					</div>
				</div>

				<div class="control-group">
					<label class="control-label"><b>Cotação notebook</b></label>
					<div class="controls">
						<input name="classproblema" type="radio" value="Cotação notebook"
							class="form-check-input" class="input-xlarge">
					</div>
				</div>

				<div class="control-group">
					<label class="control-label"><b>Cotação desktop</b></label>
					<div class="controls">
						<input name="classproblema" type="radio" value="Cotação desktop"
							class="form-check-input" class="input-xlarge">
					</div>
				</div>

				<div class="control-group">
					<label class="control-label"><b>Cotação software</b></label>
					<div class="controls">
						<input name="classproblema" type="radio" value="Cotação software"
							class="form-check-input" class="input-xlarge">
					</div>
				</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea class="form-control" rows="4" id="obs" name="obs"
						type="text" placeholder="Observações da solicitação"
