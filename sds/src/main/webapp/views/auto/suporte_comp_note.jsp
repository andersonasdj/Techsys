		...
		<form action="salvarSuporte" method="post"
			...
			<div class="text-left fonte-letras">
				...
				<div class="control-group">
					<label class="control-label"><b>Não inicia o Windows</b></label>
					<div class="controls">
						<input name="classproblema" type="radio" value="Não inicia o Windows"
							class="form-check-input" class="input-xlarge">
					</div>
				</div>

				<div class="control-group">
					<label class="control-label"><b>Não liga</b></label>
					<div class="controls">
						<input name="classproblema" type="radio" value="Não liga"
							class="form-check-input" class="input-xlarge">
					</div>
				</div>
				...
				<div class="control-group">
					<label class="control-label"><b>Apresentando lentidão</b></label>
					<div class="controls">
						<input name="classproblema" type="radio" value="Apresentando lentidão"
							class="form-check-input" class="input-xlarge">
					</div>
				</div>

				<div class="control-group">
					<label class="control-label"><b>Instalação de software</b></label>
					<div class="controls">
						<input name="classproblema" type="radio" value="Instalação de software"
							class="form-check-input" class="input-xlarge">
					</div>
				</div>
