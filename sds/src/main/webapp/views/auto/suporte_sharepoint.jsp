		...
		<form action="salvarSuporte" method="post"
			...
			<div class="text-left fonte-letras">
				...
				<div class="control-group">
					<label class="control-label"><b>Sem acesso via webmail</b></label>
					<div class="controls">
						<input name="classproblema" type="radio" value="Sem acesso via webmail"
							class="form-check-input" class="input-xlarge">
					</div>
				</div>

				<div class="control-group">
					<label class="control-label"><b>Sem acesso via mapeamento</b></label>
					<div class="controls">
						<input name="classproblema" type="radio" value="Sem acesso via mapeamento"
							class="form-check-input" class="input-xlarge">
					</div>
				</div>
				...
				<div class="control-group">
					<label class="control-label"><b>Sem permissão de acesso</b></label>
					<div class="controls">
						<input name="classproblema" type="radio" value="Sem permissão de acesso"
							class="form-check-input" class="input-xlarge">
					</div>
				</div>

				<div class="control-group">
					<label class="control-label"><b>Configuração</b></label>
					<div class="controls">
						<input name="classproblema" type="radio" value="Configuração"
							class="form-check-input" class="input-xlarge">
					</div>
				</div>
