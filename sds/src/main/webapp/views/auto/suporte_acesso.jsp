	...
	<div class="container base">
		...
		<form action="salvarSuporte" method="post"
			...
			<div class="text-left fonte-letras">
				...
				<div class="control-group">
					<label class="control-label"><b>Problemas de navegação</b></label>
					<div class="controls">
						<input name="classproblema" type="radio" value="Problemas de navegação"
							class="form-check-input" class="input-xlarge">
					</div>
				</div>

				<div class="control-group">
					<label class="control-label"><b>Lentidão na navegação</b></label>
					<div class="controls">
						<input name="classproblema" type="radio" value="Lentidão na navegação"
							class="form-check-input" class="input-xlarge">
					</div>
				</div>
			</div>
