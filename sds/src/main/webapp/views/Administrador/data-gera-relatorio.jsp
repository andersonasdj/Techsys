...
<html>
<head>
	<title>TechGold | Relatório por Período</title>
	...
	<form action="relatorioPorData" method="post" class="form-horizontal container">
		<fieldset>
			...
			<div class="control-group">
					...
					<div class="controls">
						<input id="datepicker" type="text" name="dataInicio" placeholder="Data de inicio"> <i class="fa fa-calendar fa-lg"> </i>
					</div>
			</div>
			<div class="control-group">
				<label class="control-label"></label>
				<div class="controls">
					<button id="enviar" class="btn btn-success">Gerar <i class="fa fa-spinner fa-spin fa-lg"></i></button>
