...
import br.com.techgold.model.Computador;
...
public class ComputadorController {
	...
	public String computadorForm(HttpSession session, Model model){
		...
		if (funcionario != null) {
			...
			return funcionario.getFuncao()+"/computador/computador-form";
		}else {
	...
	public String funcionariosList(HttpSession session, Model model) {
		...
		if (funcionario != null) {
			...
			return funcionario.getFuncao()+"/computador/computador-list";
		} else {
			return "redirect:login";
		}
	}
	...
	public String computadorEdit(Long id, HttpSession session, Model model) {
		...
		if (funcionario != null) {
			...
			return funcionario.getFuncao()+"/computador/computador-edit";
		} else {
			return "redirect:login";
		}
	}
