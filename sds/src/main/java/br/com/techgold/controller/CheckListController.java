...
import br.com.techgold.model.Checklist;
...
public class CheckListController {
	...
	public String checklistForm(HttpSession session, Model model){
		...
		if (funcionario != null) {
			...
			return funcionario.getFuncao()+"/checklist/checklist-form";
		}else {
	...
	public String checklistImp(Long id, HttpSession session, Model model){
		...
		if (funcionario != null) {
			...
			return funcionario.getFuncao()+"/checklist/checklist-imp";
		}else {
			return "redirect:login";
		}
	}
	...
	public String listarCheckList(HttpSession session, Model model){
		...
		if (funcionario != null) {
			...
			return funcionario.getFuncao()+"/checklist/checklist-list";
		}else {
			return "redirect:login";
		}
	}
	...
	public String checklistEdit(Long id, HttpSession session, Model model) {
		...
		if (funcionario != null) {
			...
			return funcionario.getFuncao()+"/checklist/checklist-edit";
		}else {
	...
	public String checkList(HttpSession session, Model model){
		...
		if (funcionario != null) {
			...
			return funcionario.getFuncao()+"/checklist/checklist";
		}else {
			return "redirect:login";
		}
	}
